...
use meta_athlete_runtime::{self, opaque::Block, RuntimeApi};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
  ...
  fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
    meta_athlete_runtime::api::dispatch(method, data)
  }

  fn native_version() -> sc_executor::NativeVersion {
    meta_athlete_runtime::native_version()
  }
}
...
pub fn new_partial(config: &Configuration) -> NewPartialRetTy {
